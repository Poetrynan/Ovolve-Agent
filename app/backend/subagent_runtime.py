...
#: rather than CPU. For reference, reverse-engineered peers sit anywhere from
        ...
        try:
            async with _sem():
                ...
                if not ok:
                    ...
                    # Prepend a note so the parent doesn't have to reverse-engineer
                    # from the English suffix. Kept short so it survives result
                    # truncation.
